  ...
  const renderProduct = ({ item }: { item: Product }) => (
    ...
    >
      <View className={`flex-row justify-center items-center space-x-3`}>
        ...
        />
        <Text className={`text-[#2a2a2a] font-semibold text-[20px]`}>
          {item.name}
        </Text>
      </View>
      <Text className={`text-[#2a2a2a] font-semibold text-[16px]`}>
        ...
        {products.length < 5 && (
          <View className={`flex items-center`}>
            ...
            {products.length < 1 ? (
              ...
              <Text>You can add More Products</Text>
            )}
            <TouchableOpacity
            ...
            >
              <Text
                className={`text-[#2a2a2a] font-bold text-[20px] rounded-[20px]`}
              >
                Add Products
              </Text>
            </TouchableOpacity>
